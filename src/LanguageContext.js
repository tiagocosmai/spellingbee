...
const translations = {
  en: {
    ...
    needCorrectMessage: "You need to get the word right before advancing.",
    gameEndMessage: "Game Over! Congratulations! You got {correct} out of {total} words right.",
  ...
  pt: {
    ...
    needCorrectMessage: "Você precisa acertar a palavra antes de avançar.",
    gameEndMessage: "Fim do jogo! Parabéns! Você acertou {correct} de {total} palavras.",
